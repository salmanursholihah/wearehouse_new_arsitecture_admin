...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AdminLogoutEvent);
}
...
/// @nodoc
class $AdminLogoutEventCopyWith<$Res>  {
$AdminLogoutEventCopyWith(AdminLogoutEvent _, $Res Function(AdminLogoutEvent) __);
}


/// Adds pattern-matching-related methods to [AdminLogoutEvent].
extension AdminLogoutEventPatterns on AdminLogoutEvent {
...
class _Started implements AdminLogoutEvent {
  const _Started();
...
@override
String toString() {
  return 'AdminLogoutEvent.started()';
}
...
class _Logout implements AdminLogoutEvent {
  const _Logout();
...
@override
String toString() {
  return 'AdminLogoutEvent.logout()';
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AdminLogoutState);
}
...
/// @nodoc
class $AdminLogoutStateCopyWith<$Res>  {
$AdminLogoutStateCopyWith(AdminLogoutState _, $Res Function(AdminLogoutState) __);
}


/// Adds pattern-matching-related methods to [AdminLogoutState].
extension AdminLogoutStatePatterns on AdminLogoutState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
class _Initial implements AdminLogoutState {
  const _Initial();
...
@override
String toString() {
  return 'AdminLogoutState.initial()';
}
...
class _Loading implements AdminLogoutState {
  const _Loading();
...
@override
String toString() {
  return 'AdminLogoutState.loading()';
}
...
class _Success implements AdminLogoutState {
  const _Success(this.message);
  

 final  String message;

/// Create a copy of AdminLogoutState
...
@override
String toString() {
  return 'AdminLogoutState.success(message: $message)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $AdminLogoutStateCopyWith<$Res> {
...
class _Error implements AdminLogoutState {
...
@override
String toString() {
  return 'AdminLogoutState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $AdminLogoutStateCopyWith<$Res> {
